...
public class MethodInvocationFixer
  ...
  public void visitConstantInstruction(
    ...
    if (referencedClass != null && referencedMethod != null) {
      ...
      if ((referencedMethod.getAccessFlags() & AccessConstants.STATIC) != 0) {
        ...
        if (opcode != Instruction.OP_INVOKESTATIC) {
          ...
          Instruction replacementInstruction =
              new ConstantInstruction(Instruction.OP_INVOKESTATIC, constantIndex);
      ...
      // Is the method private, or an instance initializer?
          ...
          || referencedMethod
              .getName(referencedMethodClass)
              .equals(ClassConstants.METHOD_NAME_INIT)) {
        ...
        if (opcode != Instruction.OP_INVOKESPECIAL
          ...
          Instruction replacementInstruction =
              new ConstantInstruction(Instruction.OP_INVOKESPECIAL, constantIndex);
      ...
      // Is the method an interface method?
        ...
        int invokeinterfaceConstant =
            (ClassUtil.internalMethodParameterSize(
                    referencedMethod.getDescriptor(referencedMethodClass), false))
                << 8;
        ...
        if (opcode != Instruction.OP_INVOKEINTERFACE
          ...
          Instruction replacementInstruction =
              new ConstantInstruction(
                  Instruction.OP_INVOKEINTERFACE, constantIndex, invokeinterfaceConstant);
      ...
      // an interface method.
        ...
        if (opcode != Instruction.OP_INVOKEVIRTUAL
          ...
          Instruction replacementInstruction =
              new ConstantInstruction(Instruction.OP_INVOKEVIRTUAL, constantIndex);
  ...
  private void debug(
    ...
    System.out.println(
        "  Replacement instruction = " + replacementInstruction.toString(clazz, offset));
  }
}
