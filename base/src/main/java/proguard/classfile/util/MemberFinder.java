...
public class MemberFinder implements MemberVisitor {
  ...
  /**
   * Finds the field with the given name and descriptor in the given class or its hierarchy. The
   * name and descriptor may contain wildcards.
   */
  ...
  /**
   * Finds the method with the given name and descriptor in the given class or its hierarchy. The
   * name and descriptor may contain wildcards.
   */
  ...
  public Member findMember(
    ...
    try {
      ...
      MemberVisitor memberVisitor =
          referencingClass != null && referencingClass.getName() != null
              ...
              ? isField
                  ? new AllFieldVisitor(
                      new MemberNameFilter(
                          name, new MemberDescriptorFilter(descriptor, memberVisitor)))
    ...
    try {
      ...
      clazz.hierarchyAccept(
          ...
          new NamedMethodVisitor(
              name, descriptor, new MemberAccessFilter(0, AccessConstants.PRIVATE, this)));
    } catch (MemberFoundException ex) {
