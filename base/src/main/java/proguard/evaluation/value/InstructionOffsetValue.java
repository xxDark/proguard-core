...
public class InstructionOffsetValue extends Category1Value {
  ...
  /**
   * Returns the minimum value from this list of instruction offsets. Returns <code>
   * Integer.MAX_VALUE</code> if the list is empty.
   */
  ...
  /**
   * Returns the maximum value from this list of instruction offsets. Returns <code>
   * Integer.MIN_VALUE</code> if the list is empty.
   */
